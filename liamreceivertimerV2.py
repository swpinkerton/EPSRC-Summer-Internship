...
# Generated: Mon Feb 22 14:23:28 2021
##################################################
...
class newliam101(gr.top_block):
    ...
    def __init__(self):
        ...
        self.channel_freq = channel_freq = 2e+7
        self.centre_freq = centre_freq = 2.45e+9
        ...
        self.uhd_usrp_source_0.set_bandwidth(channel_freq, 0)
        ...
        self.blocks_tag_debug_1_0 = blocks.tag_debug(gr.sizeof_char*1, 'Rx Bytes', "ofdm_sync_chan_taps"); self.blocks_tag_debug_1_0.set_display(False)
        self.blocks_tag_debug_0 = blocks.tag_debug(gr.sizeof_gr_complex*1, 'liam', ""); self.blocks_tag_debug_0.set_display(True)
        ...
        self.connect((self.digital_crc32_bb_0, 0), (self.blocks_tag_debug_1_0, 0))
    ...
    def set_channel_freq(self, channel_freq):
        ...
        self.uhd_usrp_source_0.set_bandwidth(self.channel_freq, 0)
...
def main(top_block_cls=newliam101, options=None):

    tb = top_block_cls()
    tb.start()
    time.sleep(Timersetting)
    tb.stop()
    tb.wait()
